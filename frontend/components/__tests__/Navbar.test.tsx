...
describe("Navbar", () => {
  ...
  it("muestra Panel Administrador si el usuario es admin", () => {
    ...
    expect(
      screen.getByText("Panel Administrador")
    ).toBeInTheDocument();
  });
  ...
  it("no muestra Panel Administrador si no es admin", () => {
    ...
    expect(
      screen.queryByText("Panel Administrador")
    ).not.toBeInTheDocument();
  });
