  ...
  const handleDownload = async () => {
    ...
    return (
        <div className="flex flex-col space-y-3 border border-2 rounded-xl border-primary p-6">
            ...
            <button onClick={handleDownload} className="flex mt-8 justify-center w-[200px] rounded-full bg-primary px-3 py-1.5 font-semibold leading-6 text-gray-900 shadow-sm cursor-pointer hover:bg-violet-400">Generar Informe</button>
        </div>
    )
}
