...
\restrict Iy1htvHeuA0kawlPYhhdzw4kSBlFkiRQWg0oevJvHZcjLg3f1pLG8ICfQPWB6hN
...
COPY public.proyecto (id, titulo, descripcion, "idLider", "fechaCreacion") FROM stdin;
1	taskFlow	Proyecto académico para Programación III. Consiste en la gestión de proyectos mediante CRUD de tareas y asignación a usuarios.	1	2026-05-24 07:30:00-03
\.
...
4	Probar endpoints	Probar los endpoints de las apis	\N	1	1	2	\N
\.
...
1	User	Root	user@test.com	$2b$10$PZbwyjaXGy/d4y7cJ9VKbO/vriZZYpe8w/I6Dj01G/EmLvb8Y65tK	dev
\.
...
SELECT pg_catalog.setval('public.prioridad_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.proyecto_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.tarea_id_seq', 4, true);
...
--
-- Name: prioridad UQ_1f415f5b3da9fee3fdefd789d6a; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.prioridad
    ADD CONSTRAINT "UQ_1f415f5b3da9fee3fdefd789d6a" UNIQUE (nombre);


--
-- Name: estados UQ_73d072a397aa36926ef5e741ceb; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.estados
    ADD CONSTRAINT "UQ_73d072a397aa36926ef5e741ceb" UNIQUE (nombre);
...
ALTER TABLE ONLY public.proyecto
    ADD CONSTRAINT "FK_13413546cdf2e1b97848cf2ed58" FOREIGN KEY ("idLider") REFERENCES public.usuarios(id) ON DELETE RESTRICT;
...
\unrestrict Iy1htvHeuA0kawlPYhhdzw4kSBlFkiRQWg0oevJvHZcjLg3f1pLG8ICfQPWB6hN
